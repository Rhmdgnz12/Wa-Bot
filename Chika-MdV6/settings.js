...
//—————「 Setting Owner 」—————//
global.owner = ['6285747298040','6285747298040','6285747298040'] //ubah jadi nomor kamu
global.premium = ['6285747298040'] //ubah jadi nomor kamu
global.ownernomer = '6285747298040' //ubah jadi nomor kamu

//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Al-Vian YgY' //ubah jadi nama kamu
global.botname = 'Chika-Md' //ubah jadi nama bot kamu
global.footer = 'AL Vian' //ubah jadi nama kamu

//—————「 Set Kebutuhan Button & Kontak 」—————//
global.youtube = 'gada' //ubah jadi link yt kmu, kalau gk pnya gsh di gnti anggap aja credits :)
global.ig = 'https://instagram.com/rhmd12_' //ubah jadi link ig kamu
global.mygc = 'https://chat.whatsapp.com/Nothing' //ubah jadi link group kamu
global.myweb = 'https://www.instagram.com/rhmd12_/' //terserah mau ubah/nggak
global.email = 'rahmadalvianadrianto@gmail.com' //ubah jadi email kamu
global.region = 'indonesia' //terserah mau ubah/nggak

//—————「 Set Wm 」—————//
global.packname = '© Chika-Md' //ubah jadi nama bot kamu
global.author = 'pan8' //ubah jadi nama kamu
